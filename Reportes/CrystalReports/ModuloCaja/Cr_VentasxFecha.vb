...
Public Class Cr_VentasxFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_VentasxFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_VentasxFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_VentasxFecha = New Cr_VentasxFecha
        rpt.Site = Me.Site
        Return rpt
    End Function
