...
Public Class Cr_prescripcion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_prescripcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_prescripcion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_prescripcion = New Cr_prescripcion
        rpt.Site = Me.Site
        Return rpt
    End Function
