...
Public Class Cr_InformeMedico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_InformeMedico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_InformeMedico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_InformeMedico = New Cr_InformeMedico
        rpt.Site = Me.Site
        Return rpt
    End Function
