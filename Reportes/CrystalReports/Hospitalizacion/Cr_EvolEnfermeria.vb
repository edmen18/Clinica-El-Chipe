...
Public Class Cr_EvolEnfermeria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_EvolEnfermeria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_EvolEnfermeria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_EvolEnfermeria = New Cr_EvolEnfermeria
        rpt.Site = Me.Site
        Return rpt
    End Function
