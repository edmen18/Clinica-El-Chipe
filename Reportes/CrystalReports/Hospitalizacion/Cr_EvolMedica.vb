...
Public Class Cr_EvolMedica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_EvolMedica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_EvolMedica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_EvolMedica = New Cr_EvolMedica
        rpt.Site = Me.Site
        Return rpt
    End Function
