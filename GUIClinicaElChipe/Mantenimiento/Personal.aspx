<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Personal.aspx.vb" Inherits="Mantenimiento_Personal" title="Página sin título" %>
                   ...
                   <tr>
                        ...
                        <table style="height: 34px; width: 720px;" bgcolor="White">                                    
                          <tr>
                            ...
                            <td style="width: 1075px; height: 4px;">                                
                                <asp:DropDownList ID="ddtipopersonal" runat="server">
                                </asp:DropDownList>
                            </td> 
                             <td style="width: 1328px; height: 4px;">
                    ...
                    <tr>
                     ...
                     <td style="width: 1075px">
                       <asp:Panel ID="Panel1" runat="server" Height="98px" Width="728px" 
                        CssClass="style17" GroupingText="Datos Profesionales" style="margin-left: 3px" 
                        BorderStyle="Solid" BorderWidth="1px" BackColor="White">
                        <table style="height: 34px; width: 720px;" bgcolor="White">                                    
                          <tr>
                            <td style="width: 462px; height: 4px;">
                                <asp:Label ID="Label7" runat="server" Text="Colegio"></asp:Label>
                            </td>                           
                            <td style="width: 1208px; height: 4px;">                                
                                <asp:DropDownList ID="ddcolegio" runat="server" Height="21px" Width="363px" 
                                    Enabled="False" AutoPostBack="True">
                                </asp:DropDownList>
                            </td> 
                            <td style="width: 312px; height: 4px;" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Num Colegiatura" Visible="False"></asp:Label>
                            </td>                           
                            <td style="width: 1980px; height: 4px;">                                
                                <asp:TextBox ID="txtcolegiatura" runat="server" Visible="False" Width="148px"></asp:TextBox>
                                <br />
                            </td>
                        ...
                        <table style="height: 33px; width: 720px;" bgcolor="White">                                                          
                          <tr>
                            <td style="width: 74px; height: 4px;">
                                <asp:Label ID="Label11" runat="server" Text="Condicion"></asp:Label>
                            </td>                           
                            <td style="width: 1075px; height: 4px;">
                                &nbsp;
                                <asp:DropDownList ID="ddcondicion" runat="server">
                                </asp:DropDownList>
                            </td>
                    ...
                    <table style="height: 371px; width: 740px; margin-left: 0px;" 
                       bgcolor="#DBEFF7">
                         <tr>
                            <td style="width: 1075px"> 
                             <asp:Panel ID="Panel2" runat="server" Height="191px" Width="728px" 
                        ...
                        <table style="height: 43px; width: 721px;" bgcolor="#DBEFF7">                                    
                          <tr>
                         ...
                         <table style="height: 33px; width: 720px;" bgcolor="#DBEFF7">                                    
                          <tr>
                            <td style="width: 744px; height: 4px;">
                                <asp:Label ID="Label8" runat="server" Text="Anexo"></asp:Label>
                            </td>                           
                            <td style="width: 1075px; height: 4px;">                                
                                <asp:TextBox ID="txttelanexo" runat="server" Width="150px"></asp:TextBox>
                            </td>
                            <td style="width: 405px; height: 4px;">                             
