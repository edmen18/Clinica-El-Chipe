<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Tipousuario.aspx.vb" Inherits="Mantenimiento_Tipousuario" title="Página sin título" %>
...
<td>
    <asp:GridView ID="gvtp" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:BoundField DataField="CodTipousuario" HeaderText="Codigo" />
            <asp:BoundField DataField="NomTipousuario" HeaderText="Descripción" />
        </Columns>
