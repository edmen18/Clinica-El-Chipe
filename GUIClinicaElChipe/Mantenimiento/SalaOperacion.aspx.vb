...
Partial Class Mantenimiento_SalaOperacion
    Inherits System.Web.UI.Page
    Dim fundb As New cFuncionesDB
    Dim tp As New SalaOperacion
    ...
    Protected Sub btngrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Else
            If lblind.Text = "1" Then
                If tp.AgregarSalaOperacion(lblcodigo.Text, Me.txtdescripcion.Text) Then
                ...
                '    If tp.UpdateSalaOperacion(lblcodigo.Text, Me.txtdescripcion.Text) Then
