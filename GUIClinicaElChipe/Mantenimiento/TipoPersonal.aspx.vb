...
Partial Class Mantenimiento_TipoPersonal
    ...
    Protected Sub btngrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        If lblind.Text = "1" Then
            If tp.AgregarTipoPersonal(lblcodigo.Text, Me.txtdescripcion.Text) Then
        ...
        ElseIf lblind.Text = "2" Then
            If tp.UpdateTipoPersonal(lblcodigo.Text, Me.txtdescripcion.Text) Then
