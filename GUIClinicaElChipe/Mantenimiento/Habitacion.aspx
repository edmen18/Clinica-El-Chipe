<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Habitacion.aspx.vb" Inherits="Mantenimiento_Habitacion" title="Página sin título" %>
...
<td>
    <asp:Panel ID="Panel2" runat="server" GroupingText="Listado" 
        ...
        <Columns>
            <asp:BoundField DataField="CodHabitacion" HeaderText="Codigo" />
