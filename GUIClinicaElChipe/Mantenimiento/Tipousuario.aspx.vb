...
Partial Class Mantenimiento_Tipousuario
    Inherits System.Web.UI.Page
    Dim fundb As New cFuncionesDB
    Dim tp As New TipoUsuario
    ...
    Protected Sub btngrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        If lblind.Text = "1" Then
            If tp.AgregarTipoUsuario(lblcodigo.Text, Me.txtdescripcion.Text) Then
        ...
        ElseIf lblind.Text = "2" Then
            If tp.UpdateTipoUsuario(lblcodigo.Text, Me.txtdescripcion.Text) Then
