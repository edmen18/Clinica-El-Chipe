<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="PMDiaria.aspx.vb" Inherits="ModuloProgramacionMedica_Reportes_PMDiaria" title="Página sin título" %>
...
<asp:Panel ID="Panel1" runat="server" Height="250px" Width="953px" 
                  ...
                  <td style="width: 445px">                                    
                     <asp:Panel ID="Panel2" runat="server" Height="230px" Width="721px" 
                      CssClass="style14"
                       ...
                       GroupingText="Elegir Fecha de Programación Médica">
  ...
  <asp:Panel ID="Panel4" runat="server" Height="291px" Width="953px" 
