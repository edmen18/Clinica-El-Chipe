<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="ProgramacionMedica.aspx.vb" Inherits="ModuloProgramacionMedica_Reportes_ProgramacionMedica" title="Página sin título" %>
         ...
         <tr>
            <td style="height: 28px; font-size: 18px; width: 1027px;" align="left">
                <asp:Label ForeColor="Blue" ID="Label1" runat="server" 
                    Text="Reporte de Programación Médica"></asp:Label>
            </td>
         </tr>
 </table> 
                  ...
                  <td style="width: 445px">                                    
                     <asp:Panel ID="Panel2" runat="server" Height="230px" Width="721px" 
                      CssClass="style14"
                       ...
                       GroupingText="Elija las Fechas de la Programación Médica">
                       <table style="height: 38px; width: 669px; font-size: 15px;">                                                                                                       
                        <tr>
                            <td style="width: 51px; font-size: inherit; height: 30px;">
                                ...
                                <asp:Label ID="LblFechaDel" runat="server"></asp:Label>
                            </td>
                            <td style="width: 114px; height: 30px;">
                                <asp:Label ID="Label4" runat="server" Text="Al"></asp:Label>
                                <asp:Label ID="LblFechaAl" runat="server"></asp:Label>
                            </td>                          
                        </tr>  
                        <tr>
                            <td style="width: 51px; font-size: inherit; height: 30px;">
