<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="ModuloCaja.aspx.vb" Inherits="ModuloCaja_ModuloCaja" title="Página sin título" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="height: 33px; width: 1026px;" bgcolor="#5F94C9">                                    
         <tr>
           ...
           <td style="width: 702px; height: 4px;">            
               <asp:LinkButton ID="LinkButton7" runat="server">Cerra Sesión</asp:LinkButton>
             </td>                                                   
         </tr>                                                                
    </table>    
</asp:Panel>
          ...
          <tr>
            <td style="height: 28px; font-size: 20px; width: 1027px;" align="center">
                <asp:Label ForeColor="#000099" ID="Label1" runat="server" 
                    Text="Módulo de Caja" Font-Bold="False"></asp:Label>
            </td>          
          </tr>
        </table>  
        <table border="1"                     
                        ...
                        <tr>
                           <td style="height: 1px; font-size: 20px; width: 1027px;" align="center">
                            <asp:Label ForeColor="#000099" ID="Label2" runat="server" 
                                   Text="Procesos de Caja" Font-Size="Medium"></asp:Label>
                           </td>               
                        </tr>
                        <tr>
                           <td align="center" style="height: 81px">
                               <asp:TreeView ID="TrvProcesoAdmision" runat="server" >
                                   <Nodes>
                                       <asp:TreeNode Text="Módulo Caja" Value="Módulo Admisión">
                    ...
                    <table style="height: 24px; width: 520px;" bgcolor="#DBEFF7">
                       ...
                       <tr>
                            ...
                            <asp:Label ForeColor="#000099" ID="Label4" runat="server" 
                                    Text="Procesos de Caja" Font-Size="13pt"></asp:Label>
                            </td>
                    ...
                    <table style="height: 287px; width: 520px;" bgcolor="#DBEFF7">
                         <tr>
                            ...
                            <td style="width: 1080px" align="center">
                                <asp:LinkButton ID="LinkButton6" runat="server" Font-Underline="false">Venta de Consultas</asp:LinkButton>
                               </td>
                            <td style="width: 100px">
                            </td>
                            <td style="width: 713px" class="style9" align="center">
                                <asp:LinkButton ID="LinkButton5" runat="server" Font-Underline="false">Venta de 
                                Servicios</asp:LinkButton>
                            </td>
                            <td style="width: 1075px">
                                &nbsp;
                            </td>
                            <td style="width: 801px" align="center">                               
                                <asp:LinkButton ID="LinkButton8" runat="server" Font-Underline="false">Anular 
                                venta consulta</asp:LinkButton>
                             </td>
                            <td style="width: 1075px">
                                &nbsp;
                            </td>
