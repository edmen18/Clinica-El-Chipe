...
Partial Class ModuloAdmision_Reportes
    ...
    Protected Sub TreeView1_SelectedNodeChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TrvProcesoAdmision.SelectedNodeChanged
    ...
    Protected Sub LinkButton6_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton6.Click
        Server.Transfer("~/ModuloProgramacionMedica/Reportes/PMDiaria.aspx?Valor1=" + LblUsu.Text)
    End Sub
End Class
