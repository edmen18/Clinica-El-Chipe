<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Reportes.aspx.vb" Inherits="ModuloAdmision_Reportes" title="Página sin título" MaintainScrollPositionOnPostback="true" %>
          ...
          <tr>
            <td style="height: 28px; font-size: 20px; width: 1027px;" align="center">
                <asp:Label ForeColor="#000099" ID="Label1" runat="server" 
                    Text="Módulo de Admisión" Font-Bold="False"></asp:Label>
            </td>           
          </tr>           
        </table>  
        <table border="1"                     
                    ...
                    <table style="height: 24px; width: 520px;" bgcolor="#DBEFF7">
                       ...
                       <tr>
                            ...
                            <asp:Label ForeColor="#000099" ID="Label4" runat="server" 
                                    Text="Reportes de Admisión" Font-Size="13pt"></asp:Label>
                            </td>
