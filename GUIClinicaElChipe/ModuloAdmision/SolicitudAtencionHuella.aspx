<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SolicitudAtencionHuella.aspx.vb" Inherits="ModuloAdmision_SolicitudAtencionHuella"  %>
                 ...
                 <asp:Panel ID="Panel6" runat="server" Height="62px" Width="874px" 
                     ...
                     <table style="height: 34px; width: 865px;" bgcolor="White">                                    
                        <tr>
                            ...
                            <td style="width: 4000px" class="style1">
