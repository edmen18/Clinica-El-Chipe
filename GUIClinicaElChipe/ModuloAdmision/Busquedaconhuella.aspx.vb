...
Partial Class ModuloAdmision_Busquedaconhuella
    ...
    Protected Sub GridView2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView2.SelectedIndexChanged
        ...
        Server.Transfer("~/ModuloAdmision/SolicitudAtencionHuella.aspx?codpaciente=" & (GridView2.Rows(GridView2.SelectedRow.RowIndex).Cells(9).Text) & "&historia=" & (GridView2.Rows(GridView2.SelectedRow.RowIndex).Cells(1).Text) & "&paciente=" & (GridView2.Rows(GridView2.SelectedRow.RowIndex).Cells(2).Text) & "", True)
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        Else
            cfun.FillDataGridView(p.BuscarPacienteHuella(Me.TxtBuscar.Text), GridView2)
        End If
    End Sub
End Class
