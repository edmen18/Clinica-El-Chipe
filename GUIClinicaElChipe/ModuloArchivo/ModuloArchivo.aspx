<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="ModuloArchivo.aspx.vb" Inherits="ModuloArchivo_ModuloArchivo" title="Página sin título" MaintainScrollPositionOnPostback="true" %>
...
<asp:Panel ID="Panel5" runat="server" Height="41px" BackColor="#5F94C9" 
    ...
    <table style="height: 33px; width: 1026px;" bgcolor="#5F94C9">                                    
         <tr>
           ...
           <td style="width: 915px; height: 4px;">           
               <asp:Label ID="LblTurno" runat="server"></asp:Label>
               <asp:Label ID="LblCT" runat="server" Visible="False"></asp:Label>
           </td>  
           <td style="width: 686px; height: 4px;">            
               <asp:LinkButton ID="LinkButton7" runat="server" 
                   PostBackUrl="~/InicioSesion.aspx">Cerrar Sesión</asp:LinkButton>
             </td>                                                   
         </tr>                                                                
    </table>    
</asp:Panel>
          ...
          <tr>
            <td style="height: 28px; font-size: 20px; width: 1027px;" align="center">
                <asp:Label ForeColor="#000099" ID="Label1" runat="server" 
                    Text="Módulo de Archivo" Font-Bold="False"></asp:Label>
            </td>           
          </tr>
        </table>  
        <table border="1"                     
            style="background-color: #99CCFF; font-size: medium; width: 670px; margin-left: 68px;">           
             <tr>             
                        ...
                        <tr>
                           <td style="height: 1px; font-size: 20px; width: 1027px;" align="center">
                            <asp:Label ForeColor="#000099" ID="Label2" runat="server" 
                                   Text="Procesos de Archivo" Font-Size="Medium"></asp:Label>
                           </td>               
                        </tr>
                        <tr>
                           <td align="center" style="height: 81px">
                               <asp:TreeView ID="TrvProcesoAdmision" runat="server" >
                                   <Nodes>
                                       <asp:TreeNode Text="Módulo Archivo" Value="Módulo Admisión">
                ...
                <td colspan="2" style="height: 21px">
                    <table style="height: 24px; width: 520px;" bgcolor="White">
                       ...
                       <tr>
                            ...
                            <asp:Label ForeColor="#000099" ID="Label4" runat="server" 
                                    Text="Procesos de Archivo" Font-Size="13pt"></asp:Label>
                            </td>
                    ...
                    <table style="height: 287px; width: 520px;" bgcolor="White">
                         <tr>
                            <td style="width: 1075px">                               
                            </td>
                            <td style="width: 1080px" align="center">
                                <asp:LinkButton ID="LinkButton6" runat="server" Font-Underline="false">Movimientos de las 
                                Historias Clínicas</asp:LinkButton>
                               </td>
