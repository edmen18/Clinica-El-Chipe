<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Reportes.aspx.vb" Inherits="ModuloArchivo_Reportes_Reportes" title="Página sin título" %>
                    ...
                    <table style="height: 24px; width: 520px;" bgcolor="#DBEFF7">
                       ...
                       <tr>
                            ...
                            <asp:Label ForeColor="#000099" ID="Label4" runat="server" 
                                    Text="Reportes de Archivo" Font-Size="13pt"></asp:Label>
                            </td>
                    ...
                    <table style="height: 287px; width: 520px;" bgcolor="#DBEFF7">
                         <tr>
                            ...
                            <td style="width: 1080px" align="center">
                                <asp:LinkButton ID="LinkButton6" runat="server" Font-Underline="false">Reporte 
                                de Movimientos</asp:LinkButton>
                               </td>
