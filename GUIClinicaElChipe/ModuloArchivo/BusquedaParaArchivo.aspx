<%@ Page Language="VB" MasterPageFile="~/WFPrincipal/PaginaMaestra.master" AutoEventWireup="false" CodeFile="BusquedaParaArchivo.aspx.vb" Inherits="ModuloArchivo_BusquedaParaArchivo" title="Página sin título" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <table style="width: 959px; height: 35px; margin-left: 14px; margin-top: 8px;" 
            frame="box">
          <tr>
            <td style="height: 28px; font-size: 20px; width: 848px;" align="center">
...
<asp:Panel ID="Panel1" runat="server" Height="83px" Width="953px" 
          ...
          <table style="width: 950px; height: 82px">
               <tr>              
                  <td style="width: 445px">                                    
                     <asp:Panel ID="Panel2" runat="server" Height="63px" Width="677px" 
                      CssClass="style14"
                      
                            
                          GroupingText="Búsqueda por Apellidos, Nombres, N° de Historia Clínica o Número de Ticket">
                       <table style="height: 38px; width: 669px; font-size: 15px;">                                                                                                       
                        <tr>
                            ...
                            <td style="width: 114px; height: 30px;">
                                <asp:TextBox ID="TxtBuscar" runat="server" Width="243px" 
  ...
  <asp:Panel ID="Panel3" runat="server" Height="291px" Width="953px" 
     ...
     <div style="height: 395px; width: 943px;">  
         <asp:GridView ID="GvListaArchivo" runat="server" AutoGenerateColumns="False" 
             AutoGenerateSelectButton="True" CellPadding="3" ForeColor="#333333" 
             style="margin-left: 16px" CellSpacing="2" Width="1488px">
             ...
             <Columns>
                 ...
                 <asp:BoundField DataField="FECHASOLICITUD" 
                     HeaderText="FECHA SOLICITUD ATENCION" />
                 ...
                 <asp:BoundField DataField="NOMTIPOATENCION" HeaderText="TIPO ATENCION" />
                </Columns>
